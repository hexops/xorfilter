...
pub fn Xor(comptime T: type) type {
    return struct {
        ...
        pub fn contain(self: *Self, key: u64) bool {
        ...
        fn getH0H1H2(self: *Self, k: u64) Hashes {
